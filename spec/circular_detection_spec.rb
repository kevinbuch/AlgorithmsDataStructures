...
describe CircularDetection do
  it "knows when a graph is not circular" do
    n = Vertex.new(1)
    expect(CircularDetection.part_of_cycle?(n)).to be_falsey
    ...
    expect(CircularDetection.part_of_cycle?(n1)).to be_falsey
  end
  ...
  it "knows when a graph is circular" do
    ...
    expect(CircularDetection.part_of_cycle?(n1)).to be_truthy
    ...
    expect(CircularDetection.part_of_cycle?(n4)).to be_truthy
  end
end
